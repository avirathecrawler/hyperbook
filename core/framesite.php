...
function match_youtube($url) {
    ...
    if($has_match) {
      $ret= "<iframe id=\"iframe1\" width=\"500\" height=\"330\" src=\"http://www.youtube.com/embed/".$matches[1]."\" frameBorder=\"0\" scrolling=\"no\"  allowfullscreen></iframe>";
      $ret = " <embed src=https://www.youtube.com/v/".$matches[1]." type=\"application/x-shockwave-flash\" allowscriptaccess=always width=500 height=330></embed>";
      //$ret = "http://www.youtube.com/embed/".$matches[1];
      return $ret;
    }
    return '';
}
